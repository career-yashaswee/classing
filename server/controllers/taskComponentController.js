const TaskComponent = require("../schemas/taskComponentsSchema/taskComponentsSchema");

// Create a new Task Component
exports.createTaskComponent = async (req, res) => {
  try {
...
exports.getAllTaskComponents = async (req, res) => {
  try {
...
exports.getTaskComponentById = async (req, res) => {
  try {
...
exports.updateTaskComponent = async (req, res) => {
  try {
...
exports.deleteTaskComponent = async (req, res) => {
  try {
